  ...
  return (
    <div className="flex flex-col justify-between rounded-[var(--radius-card)] border border-border bg-bg p-5">
      <div>
        ...
        <p className="mt-2 text-xs text-text-muted">{formatTimeRange(shift.startTime, shift.endTime)}</p>
      ...
      <div className="mt-5 flex items-end justify-between gap-3 border-t border-border pt-4">
        <div>
          <p className="font-mono text-base font-semibold text-accent">{formatPriceLabel(shift)}</p>

...
resource "helm_release" "postgres" {
  ...
  depends_on = [module.eks, kubernetes_secret_v1.postgres_secret]
}
...
resource "helm_release" "frontend" {
  ...
  values = [
    file("${path.module}/charts/frontend/values.yaml")
  ]
...
resource "helm_release" "lifecycle_worker" {
  ...
  chart     = "${path.module}/charts/lifecycle-worker"
  namespace = "default"

  values = [
    file("${path.module}/charts/lifecycle-worker/values.yaml")
  ]
